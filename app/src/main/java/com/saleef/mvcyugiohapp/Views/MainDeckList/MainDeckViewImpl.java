...
public class MainDeckViewImpl extends BaseObservableMvc<DeckTypeMvc.Listener> implements DeckTypeMvc,YugiohCardRecycler.Listener {
    ...
    private List<YugiohCard> currCards;
     public MainDeckViewImpl(LayoutInflater layoutInflater, ViewGroup viewGroup){
