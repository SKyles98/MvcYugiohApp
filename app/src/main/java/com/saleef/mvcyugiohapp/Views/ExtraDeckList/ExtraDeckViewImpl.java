...
public class ExtraDeckViewImpl extends BaseObservableMvc<DeckTypeMvc.Listener> implements DeckTypeMvc, YugiohCardRecycler.Listener {
    ...
    public ExtraDeckViewImpl(LayoutInflater layoutInflater, ViewGroup viewGroup){
